...
# %%
# subclustering(target_cluster=4, mother_cluster='leiden', daughter_cluster='leiden_sub_4')
...
leiden_idx_reordered_int = [
    # 11, 6, 2, 3, 9, 5, 7, 4, 10, 8
    # 17, 18, 8, 13, 16, 11, 14, 2, 12
    # 17, 10, 7, 8, 13, 16, 11, 14, 2, 12
    # 12, 7, 2, 4, 9, 3, 6, 8, 10, 11, 5
    # 11, 5, 2, 4, 8, 3, 6, 9, 10, 7
    11, 12, 4, 8, 3, 6, 9, 10, 7
]
...
img.savefig('./figures/major_endo_210430.svg', format='svg')
...
img.savefig('./figures/major_bias_210430.svg', format='svg')
...
fig.savefig('./figures/major_virus_210430.svg', format='svg')

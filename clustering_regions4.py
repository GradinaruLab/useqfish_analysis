...
gene_list_ordered = ['PHP.N', 'PHP.eB', 'PHP.B8',                  # 211229
                    'PHP.Astro', 'CAP-B10', 'PHP.V1',
                    'slc30a3', 'gad2', 
                    'cux2', 'slc17a7', 'ctgf', 'sulf2', 
                    'foxp1', 'foxp2', 'calb2', 'calb1',
                    'sst', 'pvalb', 'vip', 'drd1',
...
for v, virus in enumerate(virus_list):
    for c, cluster in enumerate(cluster_labels):
        ...
        transduction_rate[v,c] = np.count_nonzero(adata_virus[cell_inds, virus].X)*100. / n_cells_in_cluster
...
for cell in range(adata_endo.n_obs):
    ...
    position_by_cluster[pos_ind, cluster_ind] = position_by_cluster[pos_ind, cluster_ind] + 1
...
gene_list_striatum = [
    'PHP.N', 'PHP.eB', 'PHP.B8', 'PHP.Astro', 'CAP-B10', 'PHP.V1',
    'drd1', 'drd2', 'gad2', 'foxp1', 'pcp4', 'tac1', 'calb1', 'crym', 'th', 'reln'
]
...
# adata_endo.obs['leiden_new'] = adata_endo.obs['leiden']
print(adata_endo.obs['leiden_new'])
sc.tl.dendrogram(adata_endo, groupby='leiden_new', use_rep='X_pca', linkage_method='ward')
...
leiden_idx_reordered_int = [
    28, 32, 34, 37, 25, 36, 20, 19, 31, 26
]
gene_list_striatum = [
    'drd1', 'tac1', 'th', 'foxp1', 'calb1', 'drd2', 'reln', 'crym', 'pcp4', 'gad2'
]
leiden_idx_reordered = [str(idx) for idx in leiden_idx_reordered_int]
...
gene_list_thalamus = [
    'PHP.N', 'PHP.eB', 'PHP.B8', 'PHP.Astro', 'CAP-B10', 'PHP.V1',
    'rprm', 'calb1', 'slc17a7', 'pvalb', 'tnnt1', 'prkcd', 'calb2', 'rorb', 'necab1','pcp4'
]
...
# %%
leiden_idx_reordered_int = [
    53, 38, 47, 48, 42, 51, 49, 45, 36, 28
]
gene_list_thalamus = [
    'prkcd', 'tnnt1', 'pvalb', 'slc17a7', 'necab1', 'pcp4', 'rorb', 'calb2', 'calb1','rprm'
]
leiden_idx_reordered = [str(idx) for idx in leiden_idx_reordered_int]
...
# %%
subclustering(target_cluster=1, mother_cluster='leiden', daughter_cluster='leiden_sub_1')
with rc_context({'figure.figsize': (18, 15)}):
    s = sc.pl.heatmap(
        adata_endo,
        gene_list_cerebellum[6:],
...
# %%
leiden_idx_reordered_int = [
    23, 8, 14, 24, 4, 11, 2, 21, 20
]
gene_list_cerebellum = [
    'prkcd', 'ppp1r17', 'calb1', 'pcp4', 'gdf10', 'calb2', 'gabra6', 'slc17a7', 'lgi2'
]
# leiden_idx_reordered_int = [

...
leiden_idx_reordered_int = [
    57, 48, 53, 46, 41, 51, 29, 30, 52, 55
]
gene_list_striatum = [
    'drd1', 'tac1', 'foxp1', 'calb1', 'th', 'drd2', 'crym', 'reln', 'gad2', 'pcp4'
]
leiden_idx_reordered = [str(idx) for idx in leiden_idx_reordered_int]

...
# %%
leiden_idx_reordered_int = [57, 48, 53, 46, 41, 51, 29, 30, 52, 55]
gene_list_striatum = [
    "drd1",
    "tac1",
    "foxp1",
...
# %%
leiden_idx_reordered_int = [60, 58, 50, 59, 39, 61, 55, 54, 43, 32]
gene_list_thalamus = [
    "prkcd",
    "tnnt1",
    "pvalb",
...
# %%
leiden_idx_reordered_int = [29, 26, 31, 30, 34, 16, 2, 33, 32]
gene_list_cerebellum = [
    "prkcd",
    "ppp1r17",
    "calb1",

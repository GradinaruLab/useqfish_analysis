...
leiden_idx_reordered_int = [
    # 14, 15, 11, 3, 6, 13, 7, 12, 10, 8
    # 14, 16, 3, 6, 13, 7, 12, 10, 8
    # 15, 10, 14, 3, 7, 13, 8, 5, 11, 9
    14, 16, 4, 5, 13, 9, 12, 6, 7
]
...
img.savefig('./figures/major_endo_210828.svg', format='svg')
...
img.savefig('./figures/major_bias_210828.svg', format='svg')
...
fig.savefig('./figures/major_virus_210828.svg', format='svg')
